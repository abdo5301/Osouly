            ...
            <div class="modal-content">
                ...
                <div class="modal-body  param-div">
                    ...
                    <div class="form-group mb1">
                        ...
                        <div class="input-daterange input-group k_datepicker_5">
                            {!! Form::text('start_date1',null,['class'=>'form-control','autocomplete'=>'off']) !!}
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
                            </div>
                            {!! Form::text('start_date2',null,['class'=>'form-control','autocomplete'=>'off']) !!}
                        </div>
                        <span class="form-text text-muted">{{__('Linked pickers for date range selection')}}</span>
                    </div>
                    ...
                    <div class="form-group mb1">
                        ...
                        <div class="input-daterange input-group k_datepicker_5">
                            {!! Form::text('end_date1',null,['class'=>'form-control','autocomplete'=>'off']) !!}
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
                            </div>
                            {!! Form::text('end_date2',null,['class'=>'form-control','autocomplete'=>'off']) !!}
                        </div>
                        <span class="form-text text-muted">{{__('Linked pickers for date range selection')}}</span>
                    </div>
                    ...
                    <div class="form-group row mb1">
                        ...
                        <div class="col-md-6">
                            ...
                            {!! Form::number('client_package_id',null,['class'=>'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('created_by',[''=> __('Select Client')],null,['class'=>'form-control client-select','autocomplete'=>'off']) !!}
                        </div>
                    </div>
                </div>
