                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row mb1">
                             ...
                             <div class="col-md-12">
                                ...
                                {!! Form::select('owner_id',[''=> __('Select Owner')],null,['class'=>'form-control owner-select','autocomplete'=>'off','style'=>'width:100%']) !!}
                            </div>
                     </div>
    ...
    <script type="text/javascript">
        ...
        $datatable = $('#datatable-main').DataTable({
            ...
            "ajax": {
                ...
                { data: "owner_id", name: "invoices.owner_id",orderable: false,searchable: false},
                { data: "client_name", name: "clients.first_name",orderable: false,searchable: false},
                { data: "total_paid", name: "",orderable: false,searchable: false},
                { data: "total_commission", name: "",orderable: false,searchable: false},
                { data: "rest", name: "",orderable: false,searchable: false},
                { data: "total_transfare", name: "",orderable: false,searchable: false},
                { data: "transfare", name: "",orderable: false,searchable: false},
                { data: "dates", name: "",orderable: false,searchable: false},
                { data: "action", name: "",orderable: false,searchable: false},

            ], createdRow: function ( row, data, index ) {


                if( data.rest > data.total_transfare ){
                    $('td', row).css('background-color','rgb(253 255 98)');
                }
