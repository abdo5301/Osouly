        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body  param-div">
                    ...
                    <div class="form-group row mb1">
                        ...
                        {{--<div class="col-md-6">--}}
                            ...
                            {{--@php--}}
                                ...
                                {{--}--}}
                            {{--@endphp--}}
                            {{--{!! Form::select('contract_template_id',$tempsData,null,['class'=>'form-control contract-template-select']) !!}--}}
                        {{--</div>--}}
                    </div>

                    <div class="form-group row mb1">
                        <div class="col-md-6">
                            <label>{{__('Select Contract Type')}}</label>
                            {!! Form::select('contract_type',[''=>__('All'),'year'=>__('Year'),'month'=>__('Month'),'day'=>__('Day')],null,['class'=>'form-control contract-type-select']) !!}
                        </div>
                        <div class="col-md-6">
                            <label>{{__('Select Status')}}</label>
                            {!! Form::select('status',[''=>__('All'),'active'=>__('Active'),'pendding'=>__('Pending'),'cancel'=>__('Canceled')],null,['class'=>'form-control status-select']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-6">
                            <label>{{__('Deposit Rent From')}}</label>
                            {!! Form::number('deposit_rent1',null,['class'=>'form-control']) !!}
                        </div>
                        <div class="col-md-6">
                            <label>{{__('Deposit Rent To')}}</label>
                            {!! Form::number('deposit_rent2',null,['class'=>'form-control']) !!}
                        </div>
                    </div>

                    <div class="form-group row mb1">
                        <div class="col-md-6">
                            <label>{{__('Insurance Price From')}}</label>
                            {!! Form::number('insurance_price1',null,['class'=>'form-control']) !!}
                        </div>
                        <div class="col-md-6">
                            <label>{{__('Insurance Price To')}}</label>
                            {!! Form::number('insurance_price2',null,['class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
