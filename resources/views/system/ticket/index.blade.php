...
@section('content')
    ...
    <div class="k-content	k-grid__item k-grid__item--fluid k-grid k-grid--hor" id="k_content">
        ...
        <div class="k-content__head	k-grid__item">
            ...
            @if(staffCan('system.ticket.create'))
                <div class="k-content__head-toolbar">
                    <div class="k-content__head-wrapper">
                        <a href="{{route('system.ticket.create')}}" class="btn btn-sm btn-elevate btn-brand">
                            <span class="k-font-bold" id="k_dashboard_daterangepicker_date">{{__('Create TS Ticket')}}</span>
                            <i class="flaticon2-send k-padding-l-5 k-padding-r-0"></i>
                        </a>
                    </div>
                </div>
            @endif
