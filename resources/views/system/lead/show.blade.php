...
{{--                    </a>--}}
{{--                    <a href="#" data-toggle="modal" data-target="#sales-modal" class="btn btn-sm btn-elevate btn-brand" data-toggle="k-tooltip">--}}
                           ...
                           <div class="k-portlet k-portlet--mobile">
                                <div class="k-portlet__head">
                                    <div class="k-portlet__head-label">
                                        ...
                                        @if(staffCan('lead-manage-all'))
                                        <a  href="#" data-toggle="modal" data-target="#sales-modal" class="btn btn-sm btn-elevate btn-brand" data-toggle="k-tooltip"  style="margin-right: 10px;margin-left: 10px;">
                                            <span class="k-font-bold" id="k_dashboard_daterangepicker_date">  {{  __('To Sales')  }}  </span>
                                            <i class="fa fa-user  k-padding-l-5 k-padding-r-0"></i>
                                        </a>
                                        @endif
