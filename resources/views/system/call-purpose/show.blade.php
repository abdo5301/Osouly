    ...
    <div class="k-content__head	k-grid__item">
        ...
        <div class="k-content__head-toolbar">
            <div class="k-content__head-wrapper">
                ...
                <a href="{{route('system.parameter.create',['property_type_id'=>$result->id])}}" class="btn btn-sm btn-elevate btn-brand">
                    <span class="k-font-bold" id="k_dashboard_daterangepicker_date">{{__('Create')}}</span>
                    <i class="flaticon-add k-padding-l-5 k-padding-r-0"></i>
                </a>
            </div>
        </div>
    </div>
