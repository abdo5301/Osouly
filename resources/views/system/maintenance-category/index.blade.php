                ...
                <div class="modal-body  param-div">
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-12">
                            ...
                            @endphp
                            {!! Form::select('parent_id',$catData,null,['class'=>'form-control category-select','autocomplete'=>'off']) !!}
                        </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        function showSubCategories(sub_id) {
            $url = '{{url()->full()}}?is_total=true&parent_id='+sub_id;
