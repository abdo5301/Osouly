                    ...
                    <div class="k-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                {!! Form::text('columns_data_project_name',null,['class'=>'form-control','id'=>'columns_data_project_name-form-input','autocomplete'=>'off']) !!}
                                <div class="invalid-feedback" id="columns_data_project_name-form-error"></div>
                            </div>

                            <div class="col-md-6">
                                <label>{{__('Campaign Name')}}</label>
                                {!! Form::text('columns_data_campaign_name',null,['class'=>'form-control','id'=>'columns_data_campaign_name-form-input','autocomplete'=>'off']) !!}
                                <div class="invalid-feedback" id="columns_data_campaign_name-form-error"></div>
                            </div>
                        </div>
