       ...
       {{-- <div class="alert alert-light alert-elevate" role="alert">
        ...
        <div class="k-portlet k-portlet--mobile">
            <div class="k-portlet__body">
                ...
                {!! Form::open(['route' => isset($result) ? ['system.property-model.update',$result->id]:'system.property-model.store','files'=>true, 'method' => isset($result) ?  'PATCH' : 'POST','class'=> 'k-form','id'=> 'main-form','onsubmit'=> 'submitMainForm();return false;']) !!}
                    <div class="k-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                {!! Form::text('space',isset($result) ? $result->space : null,['class'=>'form-control','id'=>'space-form-input','autocomplete'=>'off']) !!}
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        function submitMainForm(){
            formSubmit(
                '{{isset($result) ? route('system.property-model.update',$result->id):route('system.property-model.store')}}',
                $('#main-form').serialize(),
                function ($data) {
