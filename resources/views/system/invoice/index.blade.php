                ...
                <div class="modal-body  param-div">
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-6">
                            ...
                            {!! Form::number('property_due_id',null,['class'=>'form-control']) !!}
                        </div>
                        <div class="col-md-6">
                            <label>{{__('Installment ID')}}</label>
                            {!! Form::number('installment_id',null,['class'=>'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('status',[''=>__('All'),'unpaid'=>__('Unpaid'),'paid'=>__('Paid')],null,['class'=>'form-control status-select']) !!}
                        </div>
                        <div class="col-md-6">
