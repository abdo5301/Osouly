        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body  param-div">
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-12">
                            <label>{{__('Select Due Name')}}</label>
                            @php
                            ...
                            @endphp
                            {!! Form::select('due_id',$duesData,null,['class'=>'form-control dues-select']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('duration',[''=>__('All'),'year'=>__('Year'),'month'=>__('Month'),'day'=>__('Day'),'one_time'=>__('One Time')],null,['class'=>'form-control duration-select']) !!}
                        </div>
                        <div class="col-md-6">
                            <label>{{__('Select Type')}}</label>
                            {!! Form::select('type',[''=>__('All'),'owner'=>__('Owner'),'renter'=>__('Renter')],null,['class'=>'form-control type-select']) !!}
                        </div>
                    </div>
