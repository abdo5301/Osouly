        ...
        <div class="k-content__head	k-grid__item">
            ...
            <div class="k-content__head-toolbar">
                <div class="k-content__head-wrapper" style="margin-left:10px;">
                    <a href="{{route('system.property-dues.edit',$result->id)}}" class="btn btn-sm btn-info btn-brand" data-toggle="k-tooltip" title="{{__('Edit Property Dues')}}" data-placement="left">
                                ...
                                <div class="k-portlet__body">
                                    <table class="table">
                                        ...
                                        @if($result->value)
                                            <tr>
                                                <td>{{__('Value')}}</td>
                                                <td>{{ amount($result->value,true)}}</td>
                                            </tr>
                                        @endif

                                        <tr>
                                            <td>{{__('Type')}}</td>
                                            <td><span class="k-badge  k-badge--success k-badge--inline k-badge--pill">{{__(ucwords($result->type))}}</span></td>
                                        </tr>

                                        <tr>
                                            <td>{{__('Duration')}}</td>
                                            <td><span class="k-badge  k-badge--success k-badge--inline k-badge--pill">{{__(ucwords(str_replace('_',' ',$result->duration)))}}</span></td>
                                        </tr>
