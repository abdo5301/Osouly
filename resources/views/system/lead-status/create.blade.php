        ...
        <div class="k-content__body	k-grid__item k-grid__item--fluid" id="k_content_body">
            ...
            <div class="k-portlet k-portlet--mobile">
                <div class="k-portlet__body">
                    ...
                    {!! Form::open(['route' => isset($result) ? ['system.lead-status.update',$result->id]:'system.lead-status.store','files'=>true, 'method' => isset($result) ?  'PATCH' : 'POST','class'=> 'k-form','id'=> 'main-form','onsubmit'=> 'submitMainForm();return false;']) !!}
                    <div class="k-portlet__body">
        ...
        @section('footer')
            ...
            <script type="text/javascript">
                ...
                function submitMainForm(){
                    formSubmit(
                        '{{isset($result) ? route('system.lead-status.update',$result->id):route('system.lead-status.store')}}',
                        $('#main-form').serialize(),
                        function ($data) {
