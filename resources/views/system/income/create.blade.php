        ...
        <div class="k-content__body	k-grid__item k-grid__item--fluid" id="k_content_body">
            <div class="k-portlet k-portlet--mobile">
                <div class="k-portlet__body">
                    ...
                    {!! Form::open(['route' => isset($result) ? ['system.income.update',$result->id]:'system.income.store','files'=>true, 'method' => isset($result) ?  'PATCH' : 'POST','class'=> 'k-form','id'=> 'main-form','onsubmit'=> 'submitMainForm();return false;']) !!}
                    <div class="k-portlet__body">
                        ...
                        <div  class="form-group row">
                            <div class="col-md-6">
                                <label>{{__('Income Price')}}<span class="red-star">*</span></label>
                        ...
                        <div  class="form-group row">
                            <div  class="col-md-12 param-div">
                                <label>{{__('Select Income Reason')}}<span class="red-star">*</span></label>
                                @php
                        ...
                        <div class="form-group row">
                            <div  class="col-md-12 param-div">
                                ...
                                @endphp
                                {!! Form::select('client_id',$clientsData,isset($result) ? $result->client_id: null,['style'=>'width: 100%','class'=>'form-control client-select','id'=>'client_id-form-input','autocomplete'=>'off']) !!}
        ...
        @section('footer')
            ...
            <script type="text/javascript">
                ...
                function submitMainForm(){
                    formSubmit(
                        '{{isset($result) ? route('system.income.update',$result->id):route('system.income.store')}}',
                        $('#main-form').serialize(),
                        function ($data) {
