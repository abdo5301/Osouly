                            ...
                            <div class="k-portlet k-portlet--height-fluid">
                                ...
                                <div class="k-portlet__body">
                                    <table class="table">
                                        ...
                                        @if($result->property_due)
                                            <tr>
                                                <td>{{__('Due Name')}}</td>
                                                <td><a target="_blank" href="{{route('system.property-dues.show',$result->property_due_id)}}" target="_blank">{{$result->property_due->name}} ({{$result->property_due->id}})</a></td>
                                            </tr>
                                        @endif

                                        @if($result->installment)
                                            <tr>
                                                <td>{{__('Installment ID')}}</td>
                                                <td>{{'# '.$result->installment_id}}</td>
                                            </tr>
                                        @endif
