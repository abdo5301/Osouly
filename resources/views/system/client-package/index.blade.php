            ...
            <div class="modal-content">
                ...
                <div class="modal-body  param-div">
                    ...
                    <div class="form-group mb1">
                        ...
                        <div class="input-daterange input-group k_datepicker_5">
                            {!! Form::text('date_from1',null,['class'=>'form-control','autocomplete'=>'off']) !!}
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
                            </div>
                            {!! Form::text('date_from2',null,['class'=>'form-control','autocomplete'=>'off']) !!}
                        </div>
                        <span class="form-text text-muted">{{__('Linked pickers for date range selection')}}</span>
                    </div>
                    ...
                    <div class="form-group mb1">
                        ...
                        <div class="input-daterange input-group k_datepicker_5">
                            {!! Form::text('date_to1',null,['class'=>'form-control','autocomplete'=>'off']) !!}
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
                            </div>
                            {!! Form::text('date_to2',null,['class'=>'form-control','autocomplete'=>'off']) !!}
                        </div>
                        <span class="form-text text-muted">{{__('Linked pickers for date range selection')}}</span>
                    </div>
                    ...
                    <div class="form-group row mb1">
                        ...
                        <div class="col-md-6">
                            ...
                            {!! Form::number('count_per_day',null,['class'=>'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('status',[''=>__('All'),'active'=>__('Active'),'pending'=>__('Pending'),'in-active'=>__('In-Active'),'cancel'=>__('Cancel'),'expired'=>__('Expired')],null,['class'=>'form-control status-select']) !!}
                        </div>
                    </div>
                </div>
