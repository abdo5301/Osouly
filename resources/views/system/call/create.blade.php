       ...
       {{-- <div class="alert alert-light alert-elevate" role="alert">
        ...
        <div class="k-portlet k-portlet--mobile">
            <div class="k-portlet__body">
                ...
                {!! Form::open(['route' => isset($result) ? ['system.call-purpose.update',$result->id]:'system.call-purpose.store','files'=>true, 'method' => isset($result) ?  'PATCH' : 'POST','class'=> 'k-form','id'=> 'main-form','onsubmit'=> 'submitMainForm();return false;']) !!}
                    <div class="k-portlet__body">
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        function submitMainForm(){
            formSubmit(
                '{{isset($result) ? route('system.call-purpose.update',$result->id):route('system.call-purpose.store')}}',
                $('#main-form').serialize(),
                function ($data) {
