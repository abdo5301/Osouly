       ...
       {{-- <div class="alert alert-light alert-elevate" role="alert">
        ...
        <div class="k-portlet k-portlet--mobile">
            <div class="k-portlet__body">
                ...
                {!! Form::open(['route' => isset($result) ? ['system.request-status.update',$result->id]:'system.request-status.store','files'=>true, 'method' => isset($result) ?  'PATCH' : 'POST','class'=> 'k-form','id'=> 'main-form','onsubmit'=> 'submitMainForm();return false;']) !!}
                    <div class="k-portlet__body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label>{{__('Color')}}<span class="red-star">*</span></label>
                                {!! Form::color('color',isset($result) ? $result->color: null,['class'=>'form-control','id'=>'color-form-input','autocomplete'=>'off']) !!}
                                <div class="invalid-feedback" id="color-form-error"></div>
                            </div>
                        </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        function submitMainForm(){
            formSubmit(
                '{{isset($result) ? route('system.request-status.update',$result->id):route('system.request-status.store')}}',
                $('#main-form').serialize(),
                function ($data) {
