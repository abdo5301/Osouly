                ...
                <div class="modal-body  param-div">
                    ...
                    <div class="form-group row mb1">
                        ...
                        <div class="col-md-6">
                            ...
                            {!! Form::select('transaction_type',[''=> __('All'),'invoice'=>__('Invoices Transactions'),'service'=>__('Services Transactions')],null,['class'=>'form-control','autocomplete'=>'off']) !!}
                        </div>
                    </div>
                    <div class="form-group row mb1">
                    <div class="col-md-6">
                    ...
                    <div class="form-group row mb1">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('status',[''=>__('All'),'pending'=>__('Pending'),'paid'=>__('Paid'),'fail'=>__('Fail')],null,['class'=>'form-control status-select']) !!}
                        </div>
                        <div class="col-md-6">
