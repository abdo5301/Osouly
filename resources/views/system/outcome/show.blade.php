        ...
        <div class="k-content__head	k-grid__item">
            ...
            <div class="k-content__head-toolbar">
                {{--<div class="k-content__head-wrapper" style="margin-left:10px;">--}}
                    {{--<a href="{{route('system.outcome.edit',$result->id)}}" class="btn btn-sm btn-info btn-brand" data-toggle="k-tooltip" title="{{__('Edit Client Data')}}" data-placement="left">--}}
                            ...
                            <div class="k-portlet k-portlet--height-fluid">
                                ...
                                <div class="k-portlet__body">
                                    <table class="table table-striped">
                                        ...
                                        @if($result->sign_id)
                                            <tr>
                                                <td>{{__('Outcome Reason')}}</td>
                                                <td> <a target="_blank"  href="{{route('system.outcome-reasons.index')}}">{{$result->sign->name}} </a></td>
                                            </tr>
                                        @endif
